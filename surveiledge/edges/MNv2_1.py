...
def on_message(client, userdata, message):
    ...
    if payload == b'stop':
        ...
        try:
            ...
            publish('172.17.0.6',str(queuePic.qsize()),'data/MNv2_Queue_Length1',1883)
...
def MNv2Refer(model_MNv2,payload,savePathPos,alpha):
    ...
    publish('172.17.0.6',str(MNv2ReferTime),'data/MNv2ReferTime1',1883)
...
def receiveMessage(queuePic,time_frame):
    ...
    client.connect('172.17.0.10', 1883 , 60)
